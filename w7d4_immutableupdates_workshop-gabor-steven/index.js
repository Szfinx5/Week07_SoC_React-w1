...
export function updateName(object, newName) {
  // trying to name the property dynamically
  let objectPropertyArray = Object.getOwnPropertyNames(object);
...
export function toggleTeaStatus(object) {
  let newObject = { ...object, needsACupOfTea: !object.needsACupOfTea };
  return newObject;
}
// Combo Time!!
...
export function toggleListItemCompleted(array, index) {
  ...
  newObject[index] = {
    task: newObject[index].task,
    completed: !newObject[index].completed,
  };
  return newObject;
}
...
function toggleListItemCompleted(array, index) {
  ...
  newObject[index] = {task: newObject[index].task, completed: !newObject[index].completed}
  console.log(newObject[index])}
